...
A small collection of app icons for use with [Loon](https://www.nsloon.com/).

## Available Icons

| App | 120 × 120 | 1024 × 1024 |
| --- | --- | --- |
...
Copy the raw URL of the icon you want and paste it into the icon URL field in Loon.

## Disclaimer

All product names, logos, and brands are the property of their respective owners. This repository is not affiliated with or endorsed by OpenAI, Anthropic, or Loon.
